...
class Repository extends Requestable {
   ...
   getRef(ref, cb) {
      ...
      return this._request('GET', `/repos/${this.__fullname}/git/refs/${ref}`, options, cb);
   }
    ...
    */
   getBlob(sha, cb, raw) {
      return this._request('GET', `/repos/${this.__fullname}/git/blobs/${sha}`, null, cb, raw != null ? raw : 'raw');
   }
